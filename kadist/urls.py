...
urlpatterns = patterns('',
                       ...
                       url(r'^graph/(?P<type>tag)/(?P<kw>.*)$', login_required(TemplateView.as_view(template_name='graph.html')), name='graph'),
                       url(r'^graph/(?P<type>work)/(?P<kw>.*)$', login_required(TemplateView.as_view(template_name='graph.html')), name='graph'),
                       url(r'^graph/(?P<type>artist)/(?P<kw>.*)$', login_required(TemplateView.as_view(template_name='graph.html')), name='graph'),
